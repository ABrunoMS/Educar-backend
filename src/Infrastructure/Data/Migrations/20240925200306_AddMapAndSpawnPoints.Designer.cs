...
namespace Educar.Backend.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240925200306_AddMapAndSpawnPoints")]
    partial class AddMapAndSpawnPoints
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Educar.Backend.Domain.Entities.Map", b =>
                {
                    ...
                    b.Property<string>("Refence2D")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("refence2d");

                    b.Property<string>("Refence3D")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("refence3d");
