...
[TestFixture]
public class MediaCreatedEventHandlerTests : TestBase
{
    private Mock<IApplicationDbContext> _contextMock;
    private MediaCreatedEventHandler _handler;

    [SetUp]
    public void SetUp()
    {
        _contextMock = new Mock<IApplicationDbContext>();
        _handler = new MediaCreatedEventHandler(_contextMock.Object);
    }
    ...
    public async Task GivenValidEvent_ShouldCreateMediaLogAndSaveChanges()
    {
        ...
        var notification = new MediaCreatedEvent(media, accountId);
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(createdLog.Action, Is.EqualTo(AuditableAction.Create));
        });
    }
